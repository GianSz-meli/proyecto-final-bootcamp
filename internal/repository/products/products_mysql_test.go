...
func TestMySQLRepository_CreateProduct(t *testing.T) {
	t.Run("should return product successfully when product is created", func(t *testing.T) {
	...
	t.Run("should return error when LastInsertId fails", func(t *testing.T) {
		...
		product := models.Product{
			...
			mock.ExpectExec("INSERT INTO products").
				WithArgs(product.ProductCode, product.Description, product.Width, product.Height, product.Length, product.NetWeight, product.ExpirationRate, product.Temperature, product.FreezingRate, product.ProductTypeID, product.SellerID).
