...
func (m *MockProductBatchRepository) Create(productBatch models.ProductBatch) (models.ProductBatch, error) {
	args := m.Called(productBatch)
	return args.Get(0).(models.ProductBatch), args.Error(1)
}

func (m *MockProductBatchRepository) GetProductCountBySection(sectionID *int) ([]models.SectionProductReport, error) {
